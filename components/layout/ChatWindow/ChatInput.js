    ...
    <div className="w-full relative">
      <div className="relative flex items-end w-full border border-foreground/15 rounded-xl bg-background shadow-xs focus-within:ring-1 ring-foreground/20 transition-all duration-200">
        <Textarea
          ...
          className="w-full border-0 shadow-none focus-visible:ring-0 has-focus-visible:ring-0 focus-visible:ring-offset-0 min-h-[6rem] max-h-[20rem] resize-none py-2 px-2 bg-transparent! text-base overflow-y-auto"
        />
